...
Оценим рост произодительности.

![Данные версии с fist_find_32 в тактах](readme_assets/takts1.png "Данные версии с fist_find_32 в тактах")
![Данные версии с fist_find_32 в процентах](readme_assets/percent1.png "Данные версии с fist_find_32 в процетнах")
![Карта произодительности версии с fist_find_32](readme_assets/squares1.png "Карта произодительности версии с fist_find_32. Проценты указаны относительно родителей. Пропорции соблюдены")

**Общее время выполнения** - $1 561 \pm 1 * 10^6$ тактов

Это лучше предыдущей версии на $24.88\% \pm 0.28\%$.

Теперь оценим изменённые показания времени выполнения. Ссамой горячей функцией является подсчёт хэша. Изменим его алгоритм и перепишем с использованием ассемблерных вставок.
