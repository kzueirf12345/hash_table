...
Чтобы анализировать только нужный участок, в котором мы непосредственно работаем с хэш-таблицей, нужно сказать об этом valgrind-у. Поэтому оградим нужную часть кода соответствующими макросами.
...
Для повторного измерения производительности воспользуемся perf в сочетании с hotspot для GUI. Так как perf не рассчитывает теоретическое время выполнение, как valgrind, а вставляет свои инструкции в код, чтобы узнать непосредственное время выполнения, увеличим размер всех файло до 1 миллиона строк. Таким образом мы сможем немного снизить погрешность. В тех же целях будем проводить несколько измерений одной и той же версии программы.