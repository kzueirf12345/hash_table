...
Самая горячая функция - `smash_map_get_val`, в которой чуть меньше половины времени занимает поиск элемента в списке. Значит будем сконцентрируемся на её оптимизации.
